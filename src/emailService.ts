...
const sendEmail = async (email: string) => {
  const mailOptions = {
    ...
    attachments: [
      {
        filename: 'Dujal_Sawarkar_Resume.pdf', // Change this to the actual filename
        path: './DujalSawarkar_Resume.pdf', // Update the path to your resume file
